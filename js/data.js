import {getRandomInRangeInt, getRandomInRangeFloat} from './util.js';
...
export const getAdsArray = (count) => Array.from({length: count}, () => new Advertesment()); // Интерфейс для генерации массива с заданным количеством объявлений
